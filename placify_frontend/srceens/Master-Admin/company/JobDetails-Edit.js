...
import { SafeAreaView, StyleSheet, ScrollView, View, Text, TouchableOpacity, Image, Animated } from 'react-native';
import FontAwesome from 'react-native-vector-icons/FontAwesome';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons';
...
const JobDetailsEdit = ({ route }) => {
  ...
  if (showPdf) {
    return <RenderPdf uri={jobDetails.fileUrl} />;
  }
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <Animated.View style={{ opacity: fadeAnim }}>
          <View style={styles.contentContainer}>
            ...
            <View style={styles.locationContainer}>
              <View style={styles.locationRectangle}>
                <Text style={styles.rectangleText}>{jobDetails.employmentType}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.locationContainer}>
              <View style={styles.locationRectangle}>
                <Text style={styles.rectangleText}>{`Rs. ${jobDetails.costToCompany}`}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.criteriaContainer}>
              <Text style={styles.criteriaTitle}>12th Percentile:</Text>
              <Text style={styles.criteriaValue}>{jobDetails.eligibilityCriteria.minimumTwelfthMarks}%</Text>
            </View>
            <View style={styles.criteriaContainer}>
              <Text style={styles.criteriaTitle}>Gender:</Text>
              <Text style={styles.criteriaValue}>{jobDetails.eligibilityCriteria.gender}</Text>
            </View>
            <View style={styles.criteriaContainer}>
              <Text style={styles.criteriaTitle}>Minimum CGPA:</Text>
              <Text style={styles.criteriaValue}>{jobDetails.eligibilityCriteria.minimumCgpa}</Text>
            </View>
          </View>
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.processContainer}>
              <Text style={styles.processText}>{jobDetails.selectionProcess}</Text>
            </View>
          </View>
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.documentsContainer}>
              <View style={styles.documentItem}>
                <Text style={styles.documentText}>Job Description</Text>
                <TouchableOpacity
